...
function AllDoctors() {
  return (
<div className=" bg-white px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-full md:px-24 lg:px-8 lg:py-20">
      ...
      <div className="grid gap-10 mx-auto lg:grid-cols-2 lg:max-w-screen-lg">
        <div className="grid sm:grid-cols-3">
         ...
         <Link className="text-lg font-bold" to="/singledoc">Oliver Aguilerra</Link>   <p ></p>
