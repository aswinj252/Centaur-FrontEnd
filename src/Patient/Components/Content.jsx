...
function Content() {
  return (
    <div className="px-4 bg-blue-950 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-full md:px-24 lg:px-8 lg:py-20">
      <div className="flex flex-col mb-6 lg:justify-between lg:flex-row md:mb-8">
        <h2 className="max-w-lg mb-5  font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none md:mb-6 group">
          ...
          <div className="h-1 ml-auto duration-300 origin-left transform bg-blue-950 scale-x-30 group-hover:scale-x-100" />
        </h2>
