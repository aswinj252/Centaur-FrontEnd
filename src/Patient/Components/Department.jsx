...
function Department() {
  ...
  const getAllDep = () =>
  {
    ...
    setDepartment(response.data.departments.departments )
    }
   )
  ...
  return (
    ...
    <div style={{width:"100%",backgroundColor:"rgb(25,42,85)"}}>
    <h1 style={{marginLeft:"20px",paddingTop:"20px", color:"white" }}><b>Our Departments</b></h1>
...
<div  key={index} className="w-full 	 max-w-sm px-4 py-3 bg-white rounded-md shadow-md dark:bg-gray-800">
...
<img className="w-full h-40" src="https://www.asterhospitals.in/sites/default/files/General/coe/Cardiac%20Sciences.svg" alt="" />
<div>
  <div className="flex items-center mt-2 text-gray-700 dark:text-gray-200">
    <span>Visit on:</span>
   <Link className="mx-2 text-blue-600 cursor-pointer dark:text-blue-400 hover:underline" to="Alldoc"> explore</Link>
