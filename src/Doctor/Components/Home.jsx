...
function Home() {
  ...
  return (
    ...
    <div className=" bg-white h-full p-4 sm:ml-64">
  <div className=" bg-white p-4 h-full  border-dashed rounded-lg dark:border-gray-700 mt-14">
    

  <div className="container max-w-full h-full px-4 mx-auto sm:px-8">
