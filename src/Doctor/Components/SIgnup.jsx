...
function SIgnup() {
  ...
  const handleSubmit = async(e) =>{
    e.preventDefault()
    console.log(file);
    // const body = JSON.stringify({name,specification,email,phone,file,password})
    // console.log(body);
  ...
  await  axios.post('/signup',formData, { headers: {'Content-Type': 'multipart/form-data'}}).then((response)=>{
